...
class NTF_Module(nn.Module):
    ...
    def future_v(self):       
        ...
        self.stat_speed = torch.clamp(self.stat_speed, min=5, max=120)
        try:
    ...
    def forward(self,x=None, v0=None, q0=None, rhoNp1=None, \
                vf=None, a_var=None, rhocr=None, g_var=None, future_r=None, future_s=None, epsq=None, epsv=None,\
                t_var=None, tau=None, nu=None, delta=None, kappa=None,\
                cap_delta=None, lambda_var=None):
        self.print_count+=1
        ...
        future_occupancies = future_densities / (self.g_var+1e-6)
        ...
        try:
            if self.print_count%self.print_every==0:
                ...
                wandb.log({"future_r": wandb.Histogram(self.future_r.cpu().cpu().detach().numpy())})
                wandb.log({"future_s": wandb.Histogram(self.future_s.cpu().cpu().detach().numpy())})
        except Exception as e:
            print(e)
