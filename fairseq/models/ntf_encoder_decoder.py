...
class NTFModel(FairseqEncoderDecoderModel):
    ...
    def build_model(cls, args, task):
        ...
        decoder = TrafficNTFDecoder(max_vals=max_vals, seq_len = output_seq_len, encoder_output_units=total_input_variables)
...
class TrafficNTFEncoder(FairseqEncoder):
    ...
    def __init__(
        ...
        seq_len=360, num_segments=12, num_var_per_segment=4,
...
class TrafficNTFDecoder(FairseqIncrementalDecoder):
    ...
    #def forward(self, prev_output_tokens, encoder_out, incremental_state=None):
        ...
        for j in range(seqlen):
            ...
            cap_delta, lambda_var, vf, a_var, rhocr, g_var, future_r, future_s, epsq, epsv =  torch.unbind(segment_params* torch.Tensor([[1.0],[10.0],[200.0],[5.0],[100.0],[10.0],[1000.0],[1000.0],[1000.0],[10.0]]).to(self.device),dim=1)
